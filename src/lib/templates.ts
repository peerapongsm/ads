...
export const TEMPLATES: Template[] = [
  {
    ...
    headlines: ["คุณคือผู้โชคดีคนที่ 1,000,000!", "ยินดีด้วย! คุณได้รับ iPhone ฟรี", "แจ้งเตือน: คุณมีของรางวัลรอรับ"],
  ...
  },
  {
    ...
    ctas: ["สมัครกู้เลย", "เช็ควงเงิน", "ทักไลน์"],
  ...
  },
  {
    ...
    headlines: ["⚠️ เครื่องคุณติดไวรัส 3 ตัว!", "แจ้งเตือนระบบ: อุปกรณ์เสี่ยงถูกแฮ็ก", "Windows ตรวจพบภัยคุกคาม"],
